...
/*   Updated: 2022/03/09 20:32:13 by asouinia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_100(t_push *push)
{
	...
	//push_to_b_all_under_n_and_n3(push, k[k_nbr / 4], k[k_nbr * 4], k[k_nbr]);
	//push_to_b_all_under_n_and_n3(push, k[k_nbr / 3], k[k_nbr * 3], k[k_nbr]);
	//push_to_b_all_under_n_and_n3(push, k[k_nbr / 2], k[k_nbr * 2], k[k_nbr]);
	//push_to_b_all_under_n_and_n3(push, k[0], k[ft_d_lstsize(push->a) - 1], k[k_nbr]);
